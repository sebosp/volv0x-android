...
package com.example.volv0x.server
...
import com.example.volv0x.toConnectionStateString
...
class GATTServerSampleService : Service() {
    ...
    companion object {
        ...
        // esp-rs created this UUID, not sure this is always the case.
        val SERVICE_UUID: UUID = UUID.fromString("997312e0-2354-11eb-9f10-fbc30a62cf38")

        // Same as the service but for the characteristic
        val CHARACTERISTIC_UUID: UUID = UUID.fromString("997312e0-2354-11eb-9f10-fbc30a62cf38")
